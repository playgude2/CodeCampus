...
/**
 * Minimal markdown renderer for generated problem statements. There's no
 * typography plugin in this project, so element styles are supplied inline via
 * arbitrary-variant utilities on the wrapper.
 */
